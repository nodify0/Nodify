...
export const TelegramIcon: React.FC<IconProps> = ({ className = '', style }) => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
    className={className}
...
export const socialMediaIcons: Record<string, React.FC<IconProps>> = {
...
export const getSocialMediaIcon = (subGroup: string | undefined): React.FC<IconProps> | null => {
  if (!subGroup) return null;
  return socialMediaIcons[subGroup] || null;
};
